...
{
    public class ProjectAndCategoryRepository : EfCoreEntityRepository<ProjectAndCategory>, IProjectAndCategoryRepository
    {
        public ProjectAndCategoryRepository(AppDbContext dbContext) : base(dbContext)
        {
        }
    }
}
